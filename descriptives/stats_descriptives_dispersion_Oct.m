...
% plot them
plot([1 1]*mean_d1,[0 max(y1)],'b:','linewidth',3)
plot([1 1]*mean_d2,[0 max(y2)],'r:','linewidth',3)
plot([1 1]*mean_d3,[0 max(y3)],'k:','linewidth',3)
...
% now plot on top
plot([mean_d1-stds(1) mean_d1+stds(1)],[.4 .4]*max(y1),'b','linewidth',10)
plot([mean_d2-stds(2) mean_d2+stds(2)],[.5 .5]*max(y2),'r','linewidth',10)
plot([mean_d3-stds(3) mean_d3+stds(3)],[.6 .6]*max(y3),'k','linewidth',10)
...
% show them!
figure(2), clf
plot(vars,varmeasures,'linewidth',3)
