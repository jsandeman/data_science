...
[p,zval] = wilcoxon_test(data1,data2)
title([ 'Wilcoxon z=' num2str(zval) ', p=' num2str(p) ])

% note: the Octave implementation requires >25 unique pairs, which is why N is higher here
...
% parameter ranges
Ns = 80:5:150; % Increased N's for Octave restrictions
