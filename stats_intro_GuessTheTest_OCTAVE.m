...
%%% IMPORTANT NOTE FOR OCTAVE USERS
%You need the statistics package installed for this course.
%If you don't have it installed, see https://octave.sourceforge.io/statistics/
...
sigtxt = {' ',' NOT '};
title([ 'The two groups are' sigtxt{(p>.05)+1} 'significantly different! t(' num2str(stats.df) ')=' num2str(round(stats.tstat*1000)/1000) ', p=' num2str(round(p*10000)/10000) ])
