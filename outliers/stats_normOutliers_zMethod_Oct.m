...
subplot(211)
plot(outliers,data(outliers),'rx','linewidth',3,'markersize',20)

subplot(212)
plot(outliers,dataZ(outliers),'rx','linewidth',3,'markersize',20)
...
while true
    ...
    % convert to z
    datamean = nanmean(dataZ);
    datastd  = nanstd(dataZ);
